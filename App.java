...
public class App extends Application {
    private final List<Map<String, Double>> weeklyData = new ArrayList<>();
    ...
    public void start(Stage primaryStage) {
        ...
        comparisonLabel.setTextFill(Color.DARKGREEN);
        ...
        VBox controlBox = new VBox(15, new Label("Select Day:"), daySelector, new Label("Spending Amount:"), inputField,
                addButton, compareButton, prevWeekButton, nextWeekButton, quitButton);
        ...
        // Layout to combine week label, comparison label, and grid
        VBox displayColumn = new VBox(20, weekLabel, comparisonLabel, dayGrid);
